  ...
  ConnectDB con;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet loadimg</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet loadimg at " + request.getContextPath() + "</h1>");
            request.getRequestDispatcher("html/load_tr.jsp").forward(request, response);
