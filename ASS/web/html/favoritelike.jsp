        ...
        <table>
            <div style="text-align: right; margin: 50px;">
                <c:if test="${pre eq true}">
                    <span><a href="flike?page=${1}&nrip=${nrip}" title="trang dau" class="previous round">&#8249; home</a></span>
                    <span><a href="flike?page=${requestScope.p-1}&nrip=${nrip}" title="truoc" class="previous">&laquo; pre</a></span>
                </c:if>
                <c:forEach var = "i" begin ="${btnStart}" end ="${btnEnd}">
                    <span> <a
                            ...
                            href="flike?page=${i}&nrip=${nrip}">${i}</a></span>
                    </c:forEach>
                    <c:if test="${next eq true}">
                    <span><a href="flike?page=${requestScope.p+1}&nrip=${nrip}" title="tiep" class="next">next &raquo;</a></span>
                    <span><a href="flike?page=${totalPage}&nrip=${nrip}" title="trang cuoi" class="next round">&#8250; End</a></span>
